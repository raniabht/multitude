  ...
  return (
    <section className="relative  sm:mt-40">
      ...
      <div className="w-full p-5 border-2 border-black bg-white flex justify-center items-center sm:w-9/12">
        <h1 className="text-6xl sm:text-7xl">MULTITUDE</h1>
      </div>

      <div className="w-full sm:flex sm:items-center">
        <div className="border-2 border-black bg-white p-5 w-4/6 sm:w-1/2">
        <p className="text-xl text-center">Adresse</p>
        <p className="text-md text-center">Quai du Hainaut 41, 1080Molenbeek-Saint-Jean</p>
      </div>

      <div className="flex justify-end  sm:justify-start  sm:w-1/2 ">
      <div className="border-2 border-black bg-white p-5 w-4/6 sm:w-full">
        <p className="text-xl text-center">periode</p>
        <p className="text-md text-center">Jun 28, 2024 - Jan 05, 2025</p>
      </div>
      </div>
      ...
      {/* txt info */}
      <div className="p-5 w-full border-2 border-black bg-white">
      ...
      <div className="w-full flex flex-row justify-end ">
          <div className="p-5 border-2 border-black w-1/2 sm:w-1/3 flex justify-center items-center cursor-pointer">
